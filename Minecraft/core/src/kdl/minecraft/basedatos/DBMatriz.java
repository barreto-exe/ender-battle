 ...
 * 
 * En la versión actual, se puede instanciar esta clase desde cualquier lugar, pero
 * no es el deber ser. En el futuro se implementará de tal forma que solo se puede 
 * obtener una instancia de la clase mediante el método <code>consultar</code>
 * de <code>DBOperacion</code>.
 * 
 * @author Luis Barreto
 * @version 0.1
 */
public class DBMatriz
{
     ...
     * Un objeto con el que se pueden operar los resultados de las consultas a las
     * bases de datos hechas con <code>DBOperacion</code>.
     * @param columnas lista previamente leída de los nombres de las columnas que 
     * arroja la consulta.
     */
    ...
    /**
     * Método utilizado en <code>DBOperacion</code>. 
     * Agrega a la matriz una fila leída en la consulta. 
